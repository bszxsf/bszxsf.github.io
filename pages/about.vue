      ...
      <el-tabs>
        ...
        <el-tab-pane label="规划">
          <ul>
            ...
            <li>使用异步组件，避免一次性加载进大量不必要的组件。</li>
            <li>处理aria，提升辅助设施体验。</li>
            <li>
